...
# print(G) #MultiGraph with 1603 nodes and 37344 edges
'''读数据'''
pos_drag1 = []
pos_drag2 = []
...
# print(cnt1) #[0, 0, 976, 84, 1, 0, 0, 0]
# print(cnt2) #[0, 0, 0, 0, 1, 965, 95, 0]
...
total_width, n = 0.8, 2
width = total_width/n
plt.title("正负样本最短距离值对比图")
plt.xlabel("最短距离值")
plt.ylabel("最短距离值出现次数")
